        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-4 transition-colors dark:border-slate-800/80 dark:bg-slate-950/80">
          <div className="flex items-center justify-between">
            ...
            <div className="mt-4 space-y-3 text-xs text-slate-700 dark:text-slate-300">
              <div className="flex items-center justify-between rounded-xl bg-slate-100 px-3 py-2.5 transition-colors dark:bg-slate-900/80">
              <div>
              ...
              <div className="text-right text-[11px]">
                ...
                <p className="text-slate-900 dark:text-slate-100">+$86.40</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-100 px-3 py-2.5 transition-colors dark:bg-slate-900/80">
              ...
              <div className="text-right text-[11px]">
                ...
                <p className="text-slate-900 dark:text-slate-100">-$42.10</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-100 px-3 py-2.5 transition-colors dark:bg-slate-900/80">
              ...
              <div className="text-right text-[11px]">
                ...
                <p className="text-slate-900 dark:text-slate-100">$0.00</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-slate-200/80 bg-white p-4 transition-colors dark:border-slate-800/80 dark:bg-slate-950/80">
            ...
            <div className="mt-3 space-y-2 text-xs text-slate-600 dark:text-slate-400">
              <div className="h-8 rounded-lg bg-slate-100 transition-colors dark:bg-slate-900/80" />
              <div className="h-8 rounded-lg bg-slate-100 transition-colors dark:bg-slate-900/80" />
              <div className="h-8 rounded-lg bg-slate-100 transition-colors dark:bg-slate-900/80" />
